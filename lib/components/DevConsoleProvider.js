...
export const DevConsoleProvider = ({ children, enabled = __DEV__, enableGestures = true, shakeThreshold = 600, longPressDelay = 1000, doubleTapDelay = 300, customActions = [], encryptionEnabled = false, onDecryptData, }) => {
    ...
    useEffect(() => {
        ...
        const handleShake = (acceleration) => {
            ...
            if (currentTime - lastShakeTimeRef.current < 1000)
                return;
    ...
    return (_jsx(DevConsoleContext.Provider, Object.assign({ value: contextValue }, { children: children })));
};
